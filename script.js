...
head.innerHTML +=`<img src="https://cdn.shopify.com/s/files/1/0486/7552/0664/collections/Lip-_-Hair-Care_1350x270.jpg?v=1639984212" class="header-image">`
    ...
    let productCards=document.querySelector(".main-card")
        ...
        for(var i=start;i<end;i++){
            ...
            <div class="price"><h4>PRICE: ${productPrice}</h4></div>
              <div class="buy"><a href="${productLink}" class="btn btn-primary" target="_blank">BUY NOW</a></div>
            </div>
          </div>`
        }
    } 
